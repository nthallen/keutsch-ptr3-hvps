...
hvps_channel::hvps_channel(int chan, QString name,
  ...
  readback_var = new adc_tmsbvar(base_addr+adc0_offset, true,
                                 (6.144/32768)*(range1/5.0), 'f', prec1);
  ...
  readback2_var = new adc_tmsbvar(base_addr+adc1_offset, true,
                                  (6.144/32768)*(range2/5.0), 'f', prec2);
